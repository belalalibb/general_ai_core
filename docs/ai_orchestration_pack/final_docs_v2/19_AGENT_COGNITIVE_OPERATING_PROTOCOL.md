...
هذا البروتوكول لا يشرح ماذا يبني الـAgent فقط، بل يحدد **كيف يفكر قبل أن يبني**.

هدفه إجبار الـAgent أو المهندس على:

```text
فهم المهمة بعمق
اختيار مستوى التفكير المناسب
مقارنة البدائل عند الحاجة
الهجوم على قراره قبل اعتماده
منع التنفيذ الكسول
منع overengineering
إثبات النجاح بالدليل
```

هذا الملف يُستخدم فوق كل الوثائق الأخرى، ولا يستبدلها.
