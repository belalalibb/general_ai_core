...
| # | item | where | do |
|---|---|---|---|
| 1 | Merge R180 PR after review | GitHub | merge COMMIT (no squash) — same posture as R179-DEC-11; re-run the canonical gate on the merge commit |
| 2 | Rotate the in-session GitHub token | GitHub settings | operator action after merge (no credential lands in the workspace) |
| 3 | Rule Q6 | `R180_READINESS.md` Part 4 | (a) or (b); until then usage is process-local, stated in OPERATIONS §13 |
