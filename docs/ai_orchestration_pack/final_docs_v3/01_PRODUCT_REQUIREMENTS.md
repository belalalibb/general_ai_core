...
SUPERSEDES:
  final_docs_v2/01_PRODUCT_REQUIREMENTS.md
MIGRATION_TYPE: CARRY (surgical cleanup only)
DECISION_PRESERVATION: All requirements, use cases, users, NFRs, scope
boundaries, and success criteria carried unchanged. No decision changed.
```
...
|---|---|
| 1–7 (vision, use cases, users, FR-001…FR-015, NFRs, MVP scope, success criteria) | v2 01 §1–7, carried verbatim |

CARRY migration: content unchanged; only the V3 authority header and this
traceability section were added. No requirement, scope boundary, or success
criterion was modified.
