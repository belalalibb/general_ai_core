"""Template 3/12 — Coding model provider (31 §6 cat. 3).

Shape represented (31 §12): API-key, code-generation-focused. Non-functional.
"""
...
MANIFEST = build_template_manifest(
    template_id="template_coding_provider",
    name="Template Coding Provider",
    capabilities=ProviderCapabilities(chat=True, code=True),
