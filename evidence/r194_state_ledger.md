...
| 8 | Regression | 18 roots (incl. `tests/events`, `tests/runtime`, `tests/api/test_webhook_producers_v6.py`, `tests/security`) at d830ac99: 3087 passed / 14 skipped-xfail / 0 failed — `evidence/r194/regression_d830ac99.txt`. | VERIFIED | 141eb531 |
| 9 | Gate of record | fresh clone of 141eb531 (`/home/user/gates/g_141eb531`, `env -i`): `RESULT: PASS`, pytest passed=3852 failed=0 errors=0 skipped=64; gateway 194; D-6 ratchet `min_passed` 3837 → 3852 (+15 = the two R194 test files). | VERIFIED | (this) |
