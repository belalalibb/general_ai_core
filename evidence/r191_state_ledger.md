...
| 13 | Gate of record | fresh clone `/home/user/gates/g_f608c669` @ f608c669, hermetic `env -i` + `PLAYWRIGHT_BROWSERS_PATH`: `RESULT: PASS` passed=3809 failed=0 errors=0 skipped=64, not_evaluated=1 (D-03); gateway-service 194 passed (`evidence/r191/gate_head_f608c669.txt`, `evidence/r191/gateway_f608c669.txt`). D-6 ratchet `min_passed` 3779 → 3809 (+30 = 8 + 11 + 11 R191 tests). | VERIFIED | (this) |
