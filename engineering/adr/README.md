...
| [ADR-0013](ADR-0013-ui-front-end-stack-and-serving-posture.md) | UI Front-End Stack and Serving Posture — QEVION Command Center (vanilla ES modules + optional hand-written WebGL vs Next/React/three; StaticFiles posture; provenance) | **PROPOSED — AWAITING OPERATOR DECISION** (R182, 2026-09-13; nothing installed) | R182 → R182-IMPL |
