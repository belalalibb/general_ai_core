...
| [ADR-0013](ADR-0013-ui-front-end-stack-and-serving-posture.md) | UI Front-End Stack and Serving Posture — QEVION Command Center (vanilla ES modules + optional hand-written WebGL vs Next/React/three; StaticFiles posture; provenance) | **ACCEPTED — Alternative C** (operator ruling D-1 + D-3 (b), 2026-09-14, R182-DEC-02; history: PROPOSED 2026-09-13) | R182 → R182-IMPL |
